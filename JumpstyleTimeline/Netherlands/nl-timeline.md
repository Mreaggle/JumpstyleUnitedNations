...
- **During the late 1980s**: [DJ Paul Elstak introduces a raw new house sound at Rotterdam's Parkzicht in 1989, an early anchor for the Dutch gabber culture and its fast `hakken` dance.](https://www.canonvannederland.nl/nl/page/292759/gabber) <!-- global-event:007 -->

#### 1990

- **During the early 1990s**: [Gabber becomes a distinct Rotterdam youth culture with its own visual identity and `hakken` dance, performed with rapid steps to the kick drum.](https://www.immaterieelerfgoed.nl/nl/gabbercultuur) <!-- global-event:008 -->

### The Undeground/Club | Hardcore/Music Era

#### 1991

- **During 1991**: [Speedy J releases "Pull Over" in 1991. Retrospective community histories often treat its bouncy kick as a prototype for the later Jump sound, but the artist's archive does not support the review's former December date.](https://speedyj.bandcamp.com/album/pull-over) <!-- global-event:010 -->
- **During 1991**: [Speedy J's Dutch techno catalogue becomes an important reference point for the harder, bouncing records circulating between the Netherlands and Belgium.](https://en.wikipedia.org/wiki/Speedy_J) <!-- global-event:011 -->

#### 1992

- **July 11**: [Rotterdam Termination Source's "Poing" enters the Dutch Top 40, reaches number two and stays there for four weeks. Its crossover success makes a raw Rotterdam dancefloor record a national pop-culture event.](https://www.top40.nl/top40-artiesten/rotterdam-termination-source) <!-- global-event:013 -->

#### 1995

- **During 1995**: [A surviving 1995 Dutch documentary preserves `hakken` as the dominant dance vocabulary around gabber and hardcore.](https://www.nowness.com/story/1995-gabber-documentary) <!-- global-event:019 -->
...
- **January**: [Hardstyle is developed by DJs like Zany and The Prophet and quickly turns into the sickest electronic music genre in Europe.](https://www.beatport.com/track/t/11033534) <!-- global-event:038 -->
...
- **January**: The dance begins to be seen in nightclubs, the old-school base is consolidated with the classic two kicks forward. <!-- global-event:041 -->

### The Internet/Google Videos | Oldschool/Tekstyle Era

#### 2005

- **February**: [In the summer of 2005, Jumpstyle became popular in the Netherlands, probably due to the hit Kom Tie Dan He! by DJ Norman vs. Darkraver.](https://www.youtube.com/watch?v=B4FP-ACzWks) <!-- global-event:045 -->
...
- **September 9**: [Ruthless & Vorwerk release "Not This Record" in the Netherlands; the release is catalogued with hard-house and Jumpstyle tags and documents the sound circulating immediately before the YouTube boom.](https://musicbrainz.org/release/0a415719-35b7-40de-afd6-b6f98a6ddae4) <!-- global-event:049 -->
...
- **February**: [Chris (aka Twisty, aka DJTwisty) would get 4 million views in his solo, DJ Twisty - Feel The Force would be registered under Aiden Music company as TikTok Jumpstyle in the future.](https://www.youtube.com/watch?v=PCSEEK6IpyU) <!-- global-event:051 -->
- **April**: [JumpingJob would be one of the first ever to record a Jumpstyle tutorial on YouTube](https://www.youtube.com/watch?v=m_IUdeG5OgI) <!-- global-event:053 -->
...
- **June**: [Twisty (aka DJTwisty) records himself dancing in his room for JumpForce.NL](https://www.youtube.com/watch?v=PCSEEK6IpyU) <!-- global-event:055 -->
...
- **August**: The 4-step 'Stamp' basis of Jumpstyle is defined as Hardjump Stamp and new styles emerge from this definition. <!-- global-event:058 -->
- **September 23**: [Jeckyll & Hyde's "Frozen Flame" enters the Dutch singles chart. It remains there for 42 weeks and reaches number 10 on that chart, while peaking at number 11 in the Dutch Top 40.](https://www.dutchcharts.nl/bestall.asp?start=2) <!-- global-event:060 -->
- **October**: [Dutch teenagers were already learning through shared online videos, giving demonstrations and lessons, and distinguishing standard Jumpstyle from Hardjump before the 2007 commercial peak.](https://3voor12.vpro.nl/lokaal/utrecht/artikelen/overzicht/2007/maart/utracks-musical-the-utrecht-story-en-jumpin-radio.html) <!-- global-event:061 -->
- **During 2006**: [Dion Teurlings films `Jumpen in de Mediamarkt`; the public video anchors the account that his rooftop clips led Patrick Pereira to ask him to teach the dance.](https://youtu.be/8c_NRKdf3Kk?si=g4fupud4N4L0UcaA) <!-- global-event:062 -->
- **During 2006**: [A surviving 2006-era video documents the slogan "Jumping is not a crime" inside Jumpstyle culture. The phrase adapts the earlier skateboarding campaign documented above.](https://www.youtube.com/watch?v=Xp8Z-A-LQXs) <!-- global-event:063 -->
- **During 2006**: [Jumpstyle demonstration videos become visible on YouTube by July, and the `Jump Is The Style` tutorial-and-forum website launches in November, creating an early dedicated learning hub.](https://knowyourmeme.com/memes/jumpstyle) <!-- global-event:065 -->
...
- **March**: [On March 31, VPRO's 3voor12 devotes a radio hour to Jumpstyle and reports that Dutch teenagers Jesse and Rick had begun learning from shared videos in October 2006; roughly ten clips had already accumulated about 600,000 views.](https://3voor12.vpro.nl/lokaal/utrecht/artikelen/overzicht/2007/maart/utracks-musical-the-utrecht-story-en-jumpin-radio.html) <!-- global-event:070 -->
- **April**: [On April 25, VPRO reports that clubs in Amsterdam, Rotterdam and The Hague were considering restrictions on Jumpstyle because crowded-floor collisions had become common, evidence of the dance's rapid mainstream saturation.](https://3voor12.vpro.nl/artikelen/jump-adepten-snappen-niks-van-jumpstyle-verbod) <!-- global-event:072 -->
...
- **June**: [On June 30, Patrick Jumpen's "Holiday" reaches its number-five peak in the Dutch Top 40. It remains on the chart for eleven weeks; it did not reach number one.](https://www.top40.nl/patrick-jumpen/patrick-jumpen-holiday-7706) <!-- global-event:078 -->
- **July 6**: [All 320 pupils at CBS De Borg receive a Jumpstyle lesson to close the Dutch school year, a local record of the dance's penetration into everyday youth culture.](https://www.harendekrant.nl/nieuws/cbs-de-borg-luidt-vakantie-met-jump-style-in/) <!-- global-event:080 -->
...
- **November 21**: [Geck-o and Cut Sphere release "That Boogie", preserving a contemporary Dutch connection to the harder, retro-informed dance sound.](https://hardstyle.com/en/tracks/749790a0-a0ea-4e66-8b62-388772c4b116/that-boogie) <!-- global-event:236 -->
- **During November**: The community review records the JumpstyleAI project being announced, renewed debate over competitive culture and community health, and Jelle leaving the JUN discussion group. <!-- global-event:237 -->
