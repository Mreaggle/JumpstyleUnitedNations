...
- **January**: [Chile's "First Summer Meet Up" is preserved by a video published on January 8; because no separate event date is stated, the upload date is used.](https://youtu.be/3MT35IfrKGs) <!-- global-event:172 -->
