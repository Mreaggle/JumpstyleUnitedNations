...
- **November 13**: [A Jumpstyle reunion is documented at Teatro Metropolitano in Tampico, Mexico, featuring Ownstyle and Hardjump; because no separate event date is stated, the upload date is used.](https://youtu.be/TNXwiscLY98) <!-- global-event:131 -->

#### 2013

- **May 13**: [Meet Up 3 in Tampico stages official Jumpstyle and Shuffle tournaments; because no separate event date is stated, the upload date is used.](https://youtu.be/nDV1pn-ti-o) <!-- global-event:136 -->

### Internet/Competitive | Instagram/Global Projects Era

#### 2016

- **August 7**: [The second Jump Meeting in Toluca, Mexico, is preserved by its organizers; because no separate event date is stated, the upload date is used.](https://youtu.be/y3PsWBdDMCs) <!-- global-event:150 -->

#### 2019

- **April 21**: [VEED'S marks its sixth CDMX meeting and sixth year in Jumpstyle; because no separate event date is stated, the upload date is used.](https://youtu.be/kMkB08ZXo1k) <!-- global-event:163 -->
