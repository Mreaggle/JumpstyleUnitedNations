...
- **March**: One of the first meetings in Lodz is recorded, but meetings were also taking place in other cities, in March the 8th meeting took place in Krakow, which would become the capital of Jump in Poland. <!-- global-event:092 -->
- **March**: [A Kraków Jump Meeting takes place on March 20, preserved through multiple participant videos and the event index at Jumpstylers.ru.](https://jumpstylers.ru/forum/23-Event-Movies/77-jump-meeting-in-krakw-20-03-2008.html) <!-- global-event:093 -->
- **May**: At this stage Polish jumpers also adopted a term for their style, distinguished by the "clean" technique, and called it Ownstyle, which would later create a rift between the two countries. <!-- global-event:095 -->
- **May**: [Kraków hosts another documented Jump Meeting on May 2, demonstrating the frequency of organized Polish gatherings during the formative Ownstyle period.](https://jumpstylers.ru/forum/23-Event-Movies/78-jump-meeting-in-krakw-02-05-2008.html) <!-- global-event:096 -->
...
- **July**: [A video published on July 20 preserves what its Polish organizers describe as the first official nationwide Jumpstyle meeting in Poznań; because no event date survives in the title or description, the upload date is used.](https://youtu.be/YwKwPgXWYRo) <!-- global-event:101 -->
- **December**: [A major Krakow meeting gathers jumpers from across Poland; footage preserves the scale of the Polish scene as Ownstyle and competitive formats take shape.](https://youtu.be/5EAadhCfrLs?si=gNh-_UamFItl2jkB) <!-- global-event:108 -->
...
- **During 2008**: [Mroziu's spin footage](https://youtu.be/Dn2LdHUlDaw?si=IAMF-ijFN0KK-kT1) and [gym recording](https://m.youtube.com/watch?v=ulQG3gfEmQ4) preserve the multi-spin vocabulary that the community review associates with figure-skating influence on Polish Ownstyle. <!-- global-event:111 -->
- **During 2008**: The same review attributes the large Kraków gathering preserved above to Fantom and records roughly 70 participants; it also records Vlad SheVa encountering Jumpstyle during the year. <!-- global-event:112 -->

### Internet/Competitive | Polish Ownstyle/Russian Sidejump

#### 2009

- **February**: The Polish Jumpstyle league is also in full swing and they work in the same way on the JumpstylePolska.pl forum. DannieL and Iceman are great legends and in March we have the biggest national meeting registered in Poland. <!-- global-event:116 -->
- **February**: [A preserved April 2009 snapshot of JumpstylePolska.pl shows dedicated forum sections for `Zloty` (meetings) and `Liga Jumpstyle Polska`, confirming the community infrastructure behind Poland's events and leagues.](https://web.archive.org/web/20090416222333/http://www.jumpstylepolska.pl/) <!-- global-event:117 -->
- **March**: [A surviving film records the large Polish national gathering remembered by the community review as receiving RMF MAXXX support.](https://www.youtube.com/watch?v=3SUriHS1L5Y) <!-- global-event:120 -->
- **June**: [Atomic Destination Team founded in 2009 (ADT) participates in Poland's Got Talent program.](https://www.youtube.com/watch?v=B4FP-ACzWks) <!-- global-event:124 -->
- **July**: Poland created its own aesthetic and tricks and called it The Ownstyle. <!-- global-event:125 -->
...
- **November 28**: [Gliwice hosts its third regional Polish Jump Meeting, preserved in the multilingual event archive at Jumpstylers.ru.](https://jumpstylers.ru/forum/23-Event-Movies/925-3rd-regional-jumpmeeting-in-gliwice-pl-28th-november-2009.html) <!-- global-event:133 -->
- **During 2009**: The same review preserves the planned Furious Squad/Wawa Jumpers collaboration and the Tapsik versus DannieL battle at a Kraków meeting as community testimony requiring further event-level documentation. <!-- global-event:136 -->
